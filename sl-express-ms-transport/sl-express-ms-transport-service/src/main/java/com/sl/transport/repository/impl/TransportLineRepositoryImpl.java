...
public class TransportLineRepositoryImpl implements TransportLineRepository {
    ...
    private Collection<TransportLineNodeDTO> executeQueryPath(String cypherQuery, AgencyEntity start, AgencyEntity end) {
    ...
    public List<TransportLineNodeDTO> findPathList(AgencyEntity start, AgencyEntity end, int depth, int limit) {
        ...
        return (List<TransportLineNodeDTO>) this.executeQueryPath(cypherQuery, start, end);
    }
