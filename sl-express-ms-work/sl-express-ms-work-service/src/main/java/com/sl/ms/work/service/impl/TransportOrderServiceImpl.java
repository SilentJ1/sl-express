...
public class TransportOrderServiceImpl implements TransportOrderService {
    ...
    public TransportOrderEntity orderToTransportOrder(Long orderId) {
        ...
        boolean result = TransportOrderService.super.save(transportOrder);
    ...
    public Page<TransportOrderEntity> findByPage(TransportOrderQueryDTO transportOrderQueryDTO) {
        ...
        return TransportOrderService.super.page(iPage, lambdaQueryWrapper);
    }

    @Override
    public TransportOrderEntity findByOrderId(Long orderId) {
        return this.getOne(Wrappers.<TransportOrderEntity>lambdaQuery().eq(TransportOrderEntity::getOrderId, orderId));
    }
    ...
    public List<TransportOrderEntity> findByOrderIds(Long[] orderIds) {
        ...
        return TransportOrderService.super.list(queryWrapper);
    }
    ...
    public boolean updateStatus(List<String> ids, TransportOrderStatus transportOrderStatus) {
        ...
        if (TransportOrderStatus.REJECTED == transportOrderStatus) {
            //查询运单列表
            transportOrderList = TransportOrderService.super.listByIds(ids);
        ...
        //批量更新数据
        boolean result = TransportOrderService.super.updateBatchById(transportOrderList);

        //发消息通知其他系统运单状态的变化
        this.sendUpdateStatusMsg((ArrayList<String>) ids, transportOrderStatus);
    ...
    public boolean updateByTaskId(Long taskId) {
        ...
        //查询运单列表
        List<TransportOrderEntity> transportOrderList = TransportOrderService.super.listByIds(transportOrderIdList);
        ...
        //批量更新运单
        return TransportOrderService.super.updateBatchById(transportOrderList);
    }
    ...
    public List<TransportOrderStatusCountDTO> findStatusCount() {
        ...
        List<TransportOrderStatusCountDTO> statusCount = transportOrderMapper.findStatusCount();
    ...
    @Override
    public boolean saveBatch(Collection<TransportOrderEntity> entityList, int batchSize) {
        return false;
    }

    @Override
    public boolean saveOrUpdateBatch(Collection<TransportOrderEntity> entityList, int batchSize) {
        return false;
    }

    @Override
    public boolean updateBatchById(Collection<TransportOrderEntity> entityList, int batchSize) {
        return false;
    }

    @Override
    public boolean saveOrUpdate(TransportOrderEntity entity) {
        return false;
    }

    @Override
    public TransportOrderEntity getOne(Wrapper<TransportOrderEntity> queryWrapper, boolean throwEx) {
        return null;
    }

    @Override
    public Map<String, Object> getMap(Wrapper<TransportOrderEntity> queryWrapper) {
        return Map.of();
    }

    @Override
    public <V> V getObj(Wrapper<TransportOrderEntity> queryWrapper, Function<? super Object, V> mapper) {
        return null;
    }

    @Override
    public BaseMapper<TransportOrderEntity> getBaseMapper() {
        return null;
    }

    @Override
    public Class<TransportOrderEntity> getEntityClass() {
        return null;
    }
}
